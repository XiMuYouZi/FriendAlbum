...
//    CGPoint textPosition = CGPointMake(floor(CGRectGetMinX(frameRect)), floor(CGRectGetMaxY(frameRect)));
//    CFIndex start = 0;
...
- (void)calculateLines {
    ...
    for (; index < lineCount; index++) {
        ...
        CGRect lineRect = CGRectMake(origin.x, origin.y - descent, width, ascent + descent);
...
- (void)setSelectionWithPoint:(CGPoint)point {
    ...
    CFStringTokenizerRef tokenizer = CFStringTokenizerCreate(NULL, string, range, kCFStringTokenizerUnitWordBoundary, NULL);
