...
- (void)_setup {
    ...
    _userNameLabel = [[UILabel alloc] initWithFrame:CGRectMake(93, 0, 220, 34)];
    _userNameLabel.textColor = [UIColor whiteColor];
    _userNameLabel.backgroundColor = [UIColor clearColor];
    _userNameLabel.shadowColor = [UIColor blackColor];
    _userNameLabel.shadowOffset = CGSizeMake(0, 2);
    _userNameLabel.font = [UIFont boldSystemFontOfSize:26.0f];
    
    _birthdayLabel = [[UILabel alloc] initWithFrame:CGRectMake(93, 42, 220, 24)];
