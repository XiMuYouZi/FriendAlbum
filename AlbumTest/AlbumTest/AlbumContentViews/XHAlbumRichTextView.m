...
+ (CGFloat)getSharePhotoCollectionViewHeightWithPhotos:(NSArray *)photos {
    ...
    return (row * albumPhotoSize + (row - 1) * kXHAlbumPhotoInsets);
}
...
- (void)setDisplayAlbum:(XHAlbum *)displayAlbum {
    ...
    [_avatarImageView sd_setImageWithURL:[NSURL URLWithString:_displayAlbum.profileAvatarUrlString] placeholderImage:[UIImage imageNamed:@"book"]];
...
- (UIImageView *)avatarImageView {
    if (!_avatarImageView) {
        ...
        _avatarImageView.image = [UIImage imageNamed:@"book"];
    }
...
- (void)layoutSubviews {
    ...
    CGRect sharePhotoCollectionViewFrame = CGRectMake(richTextViewX, CGRectGetMaxY(richTextViewFrame) + kXHAlbumPhotoInsets, kXHAlbumPhotoInsets * 4 + albumPhotoSize * 3, [XHAlbumRichTextView getSharePhotoCollectionViewHeightWithPhotos:self.displayAlbum.albumSharePhotos]);
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell.photoImageView sd_setImageWithURL:[NSURL URLWithString:self.displayAlbum.albumSharePhotos[indexPath.item]]];
    return cell;
}
